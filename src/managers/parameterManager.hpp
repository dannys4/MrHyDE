...
namespace MrHyDE {
  ...
  public:
    ...
    void setParameters(const std::vector<double> &new_vals, const std::vector<int> &indices);
    ...
    std::vector<int> getParameterIndices(const std::vector<std::string> &whichparam);
